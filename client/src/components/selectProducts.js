                    ...
                    <Grid item xs={3}>
                        <ExpansionPanel>
                            <ExpansionPanelSummary
                                ...
                                id="panel1a-header"
                            >
                                <Typography onClick={() => pushhh()} className={classes.heading}>Blush</Typography>
                            </ExpansionPanelSummary>
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary
                                ...
                                id="panel1a-header"
                            >
                                <Typography className={classes.heading}>Eyeshadow</Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <Typography>
                                    Select a brand:
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary
                                ...
                                id="panel1a-header"
                            >
                                <Typography className={classes.heading}>Lipstick</Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <Typography>
                                    Select a brand:
                        ...
                        <ExpansionPanel>
                            <ExpansionPanelSummary
                                ...
                                id="panel1a-header"
                            >
                                <Typography className={classes.heading}>Bronzer</Typography>
                            </ExpansionPanelSummary>
                            <ExpansionPanelDetails>
                                <Typography>
                                    Select a brand:
